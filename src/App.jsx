...
const RAW_BANK = {
  ...
  400:[
    ...
    {q:"Guess the influencer from the image",a:"Rosanna Pansino",wiki:"Rosanna_Pansino"},
  ...
  600:[
    ...
    {q:"Guess the influencer from the image",a:"Rhett McLaughlin",wiki:"Rhett_McLaughlin"},
  ...
  who_artist:{label:"Which Artist Am I?",icon:"\u{1F3A4}",color:"#9333EA",isWhoAmI:true,
  200:[
    {q:"Guess the music artist from the image",a:"Taylor Swift",wiki:"Taylor_Swift"},
    {q:"Guess the music artist from the image",a:"Beyoncé",wiki:"Beyonc%C3%A9"},
    {q:"Guess the music artist from the image",a:"Rihanna",wiki:"Rihanna"},
    {q:"Guess the music artist from the image",a:"Drake",wiki:"Drake_(musician)"},
    {q:"Guess the music artist from the image",a:"Eminem",wiki:"Eminem"},
    {q:"Guess the music artist from the image",a:"Ed Sheeran",wiki:"Ed_Sheeran"},
    {q:"Guess the music artist from the image",a:"Adele",wiki:"Adele"},
    {q:"Guess the music artist from the image",a:"Ariana Grande",wiki:"Ariana_Grande"},
    {q:"Guess the music artist from the image",a:"Bruno Mars",wiki:"Bruno_Mars"},
    {q:"Guess the music artist from the image",a:"The Weeknd",wiki:"The_Weeknd"},
    {q:"Guess the music artist from the image",a:"Justin Bieber",wiki:"Justin_Bieber"},
    {q:"Guess the music artist from the image",a:"Madonna",wiki:"Madonna"},
    {q:"Guess the music artist from the image",a:"Elvis Presley",wiki:"Elvis_Presley"},
    {q:"Guess the music artist from the image",a:"Kanye West",wiki:"Kanye_West"},
    {q:"Guess the music artist from the image",a:"Post Malone",wiki:"Post_Malone"},
    {q:"Guess the music artist from the image",a:"Dua Lipa",wiki:"Dua_Lipa"},
    {q:"Guess the music artist from the image",a:"Selena Gomez",wiki:"Selena_Gomez"},
    {q:"Guess the music artist from the image",a:"Lady Gaga",wiki:"Lady_Gaga"},
    {q:"Guess the music artist from the image",a:"Billie Eilish",wiki:"Billie_Eilish"},
    {q:"Guess the music artist from the image",a:"Harry Styles",wiki:"Harry_Styles"},
    {q:"Guess the music artist from the image",a:"Bad Bunny",wiki:"Bad_Bunny"},
    {q:"Guess the music artist from the image",a:"Shakira",wiki:"Shakira"},
    {q:"Guess the music artist from the image",a:"Jennifer Lopez",wiki:"Jennifer_Lopez"},
    {q:"Guess the music artist from the image",a:"Katy Perry",wiki:"Katy_Perry"},
    {q:"Guess the music artist from the image",a:"Michael Jackson",wiki:"Michael_Jackson"},
    {q:"Guess the music artist from the image",a:"Snoop Dogg",wiki:"Snoop_Dogg"},
    {q:"Guess the music artist from the image",a:"Jay-Z",wiki:"Jay-Z"},
    {q:"Guess the music artist from the image",a:"Miley Cyrus",wiki:"Miley_Cyrus"},
    {q:"Guess the music artist from the image",a:"Shawn Mendes",wiki:"Shawn_Mendes"},
    {q:"Guess the music artist from the image",a:"Camila Cabello",wiki:"Camila_Cabello"},
  ...
  400:[
    ...
    {q:"Guess the music artist from the image",a:"Travis Scott",wiki:"Travis_Scott"},
    {q:"Guess the music artist from the image",a:"SZA",wiki:"SZA_(singer)"},
    {q:"Guess the music artist from the image",a:"Doja Cat",wiki:"Doja_Cat"},
    {q:"Guess the music artist from the image",a:"Olivia Rodrigo",wiki:"Olivia_Rodrigo"},
    {q:"Guess the music artist from the image",a:"Lil Wayne",wiki:"Lil_Wayne"},
    {q:"Guess the music artist from the image",a:"Nicki Minaj",wiki:"Nicki_Minaj"},
    {q:"Guess the music artist from the image",a:"J. Cole",wiki:"J._Cole"},
    {q:"Guess the music artist from the image",a:"Pharrell Williams",wiki:"Pharrell_Williams"},
    {q:"Guess the music artist from the image",a:"Lizzo",wiki:"Lizzo"},
    {q:"Guess the music artist from the image",a:"Halsey",wiki:"Halsey_(singer)"},
    {q:"Guess the music artist from the image",a:"Khalid",wiki:"Khalid_(singer)"},
    {q:"Guess the music artist from the image",a:"21 Savage",wiki:"21_Savage"},
    {q:"Guess the music artist from the image",a:"Cardi B",wiki:"Cardi_B"},
    {q:"Guess the music artist from the image",a:"Megan Thee Stallion",wiki:"Megan_Thee_Stallion"},
    {q:"Guess the music artist from the image",a:"Lil Nas X",wiki:"Lil_Nas_X"},
    {q:"Guess the music artist from the image",a:"Chris Brown",wiki:"Chris_Brown"},
    {q:"Guess the music artist from the image",a:"Pitbull",wiki:"Pitbull_(rapper)"},
    {q:"Guess the music artist from the image",a:"Usher",wiki:"Usher_(musician)"},
    {q:"Guess the music artist from the image",a:"Alicia Keys",wiki:"Alicia_Keys"},
    {q:"Guess the music artist from the image",a:"John Legend",wiki:"John_Legend"},
    {q:"Guess the music artist from the image",a:"Adam Levine",wiki:"Adam_Levine"},
    {q:"Guess the music artist from the image",a:"Pink",wiki:"Pink_(singer)"},
    {q:"Guess the music artist from the image",a:"Kelly Clarkson",wiki:"Kelly_Clarkson"},
    {q:"Guess the music artist from the image",a:"Sam Smith",wiki:"Sam_Smith"},
    {q:"Guess the music artist from the image",a:"J Balvin",wiki:"J_Balvin"},
    {q:"Guess the music artist from the image",a:"Calvin Harris",wiki:"Calvin_Harris"},
  ...
  600:[
    {q:"Guess the music artist from the image",a:"David Bowie",wiki:"David_Bowie"},
    {q:"Guess the music artist from the image",a:"Prince",wiki:"Prince_(musician)"},
    {q:"Guess the music artist from the image",a:"Freddie Mercury",wiki:"Freddie_Mercury"},
    {q:"Guess the music artist from the image",a:"Jimi Hendrix",wiki:"Jimi_Hendrix"},
    {q:"Guess the music artist from the image",a:"Bob Dylan",wiki:"Bob_Dylan"},
    {q:"Guess the music artist from the image",a:"Janis Joplin",wiki:"Janis_Joplin"},
    {q:"Guess the music artist from the image",a:"Amy Winehouse",wiki:"Amy_Winehouse"},
    {q:"Guess the music artist from the image",a:"Kurt Cobain",wiki:"Kurt_Cobain"},
    {q:"Guess the music artist from the image",a:"Tupac Shakur",wiki:"Tupac_Shakur"},
    {q:"Guess the music artist from the image",a:"The Notorious B.I.G.",wiki:"The_Notorious_B.I.G."},
    {q:"Guess the music artist from the image",a:"Bob Marley",wiki:"Bob_Marley"},
    {q:"Guess the music artist from the image",a:"Stevie Wonder",wiki:"Stevie_Wonder"},
    {q:"Guess the music artist from the image",a:"Aretha Franklin",wiki:"Aretha_Franklin"},
    {q:"Guess the music artist from the image",a:"James Brown",wiki:"James_Brown"},
    {q:"Guess the music artist from the image",a:"Marvin Gaye",wiki:"Marvin_Gaye"},
    {q:"Guess the music artist from the image",a:"Whitney Houston",wiki:"Whitney_Houston"},
    {q:"Guess the music artist from the image",a:"Mariah Carey",wiki:"Mariah_Carey"},
    {q:"Guess the music artist from the image",a:"Celine Dion",wiki:"Celine_Dion"},
    {q:"Guess the music artist from the image",a:"Barbra Streisand",wiki:"Barbra_Streisand"},
    {q:"Guess the music artist from the image",a:"Nina Simone",wiki:"Nina_Simone"},
    {q:"Guess the music artist from the image",a:"Billie Holiday",wiki:"Billie_Holiday"},
    {q:"Guess the music artist from the image",a:"Chuck Berry",wiki:"Chuck_Berry"},
    {q:"Guess the music artist from the image",a:"Little Richard",wiki:"Little_Richard"},
    {q:"Guess the music artist from the image",a:"Leonard Cohen",wiki:"Leonard_Cohen"},
    {q:"Guess the music artist from the image",a:"Joni Mitchell",wiki:"Joni_Mitchell"},
    {q:"Guess the music artist from the image",a:"Diana Ross",wiki:"Diana_Ross"},
    {q:"Guess the music artist from the image",a:"Tina Turner",wiki:"Tina_Turner"},
    {q:"Guess the music artist from the image",a:"Cher",wiki:"Cher"},
    {q:"Guess the music artist from the image",a:"Gwen Stefani",wiki:"Gwen_Stefani"},
    {q:"Guess the music artist from the image",a:"Elton John",wiki:"Elton_John"},
  ...
  country_capitals:{label:"Country Capitals",icon:"\u{1F5FA}\uFE0F",color:"#0EA5E9",capitalsMode:true,
  200:[
    {q:"Paris",a:"France"},
    {q:"London",a:"United Kingdom"},
    {q:"Rome",a:"Italy"},
    {q:"Tokyo",a:"Japan"},
    {q:"Moscow",a:"Russia"},
    {q:"Berlin",a:"Germany"},
    ...
    {q:"Beijing",a:"China"},
    {q:"Cairo",a:"Egypt"},
    {q:"Washington, D.C.",a:"United States"},
    {q:"Ottawa",a:"Canada"},
    {q:"Canberra",a:"Australia"},
    {q:"New Delhi",a:"India"},
    {q:"Athens",a:"Greece"},
    {q:"Dublin",a:"Ireland"},
    {q:"Lisbon",a:"Portugal"},
    {q:"Seoul",a:"South Korea"},
    {q:"Bangkok",a:"Thailand"},
    {q:"Buenos Aires",a:"Argentina"},
    {q:"Stockholm",a:"Sweden"},
    {q:"Oslo",a:"Norway"},
    {q:"Copenhagen",a:"Denmark"},
    {q:"Helsinki",a:"Finland"},
    {q:"Vienna",a:"Austria"},
    {q:"Budapest",a:"Hungary"},
    {q:"Warsaw",a:"Poland"},
    {q:"Brussels",a:"Belgium"},
  ...
  400:[
    {q:"Ankara",a:"Turkey"},
    {q:"Bern",a:"Switzerland"},
    {q:"Riyadh",a:"Saudi Arabia"},
    {q:"Tehran",a:"Iran"},
    {q:"Baghdad",a:"Iraq"},
    {q:"Beirut",a:"Lebanon"},
    {q:"Amman",a:"Jordan"},
    ...
    {q:"Muscat",a:"Oman"},
    {q:"Manama",a:"Bahrain"},
    {q:"Kuwait City",a:"Kuwait"},
    {q:"Islamabad",a:"Pakistan"},
    {q:"Dhaka",a:"Bangladesh"},
    {q:"Kathmandu",a:"Nepal"},
    {q:"Colombo",a:"Sri Lanka"},
    {q:"Phnom Penh",a:"Cambodia"},
    {q:"Hanoi",a:"Vietnam"},
    {q:"Jakarta",a:"Indonesia"},
    {q:"Kuala Lumpur",a:"Malaysia"},
    {q:"Manila",a:"Philippines"},
    {q:"Brasília",a:"Brazil"},
    {q:"Santiago",a:"Chile"},
    {q:"Lima",a:"Peru"},
    {q:"Prague",a:"Czech Republic"},
    {q:"Kyiv",a:"Ukraine"},
    {q:"Bucharest",a:"Romania"},
    {q:"Sofia",a:"Bulgaria"},
    {q:"Belgrade",a:"Serbia"},
    {q:"Zagreb",a:"Croatia"},
    {q:"Wellington",a:"New Zealand"},
  ...
  600:[
    ...
    {q:"Ljubljana",a:"Slovenia"},
    {q:"Sarajevo",a:"Bosnia and Herzegovina"},
    {q:"Skopje",a:"North Macedonia"},
    {q:"Podgorica",a:"Montenegro"},
    {q:"Tirana",a:"Albania"},
    {q:"Chisinau",a:"Moldova"},
    {q:"Yerevan",a:"Armenia"},
    {q:"Tbilisi",a:"Georgia"},
    {q:"Baku",a:"Azerbaijan"},
    {q:"Tashkent",a:"Uzbekistan"},
    {q:"Bishkek",a:"Kyrgyzstan"},
    {q:"Ashgabat",a:"Turkmenistan"},
    {q:"Astana",a:"Kazakhstan"},
    {q:"Dushanbe",a:"Tajikistan"},
    {q:"Valletta",a:"Malta"},
    {q:"Reykjavík",a:"Iceland"},
    {q:"Tallinn",a:"Estonia"},
    {q:"Riga",a:"Latvia"},
    {q:"Vilnius",a:"Lithuania"},
    {q:"Vaduz",a:"Liechtenstein"},
    {q:"Nassau",a:"Bahamas"},
    {q:"Port-au-Prince",a:"Haiti"},
    {q:"Santo Domingo",a:"Dominican Republic"},
    {q:"Tegucigalpa",a:"Honduras"},
    {q:"Managua",a:"Nicaragua"},
    {q:"Caracas",a:"Venezuela"},
    {q:"Bogotá",a:"Colombia"},
    {q:"Quito",a:"Ecuador"},
  ...
  spelling_bee:{label:"Spelling Bee",icon:"\u{1F41D}",color:"#D97706",isSpellingBee:true,
  200:[
    {q:"Spell this word",a:"Rhythm"},
    {q:"Spell this word",a:"Tomorrow"},
    {q:"Spell this word",a:"Necessary"},
    {q:"Spell this word",a:"February"},
    {q:"Spell this word",a:"Wednesday"},
    {q:"Spell this word",a:"Business"},
    {q:"Spell this word",a:"Embarrass"},
    {q:"Spell this word",a:"Neighbor"},
    {q:"Spell this word",a:"Receive"},
    {q:"Spell this word",a:"Friend"},
    {q:"Spell this word",a:"Occurred"},
    {q:"Spell this word",a:"Beautiful"},
    {q:"Spell this word",a:"Island"},
    {q:"Spell this word",a:"Scissors"},
    {q:"Spell this word",a:"Separate"},
    {q:"Spell this word",a:"Definitely"},
    {q:"Spell this word",a:"Calendar"},
    {q:"Spell this word",a:"Tongue"},
    ...
    {q:"Spell this word",a:"Cousin"},
    {q:"Spell this word",a:"Answer"},
    {q:"Spell this word",a:"Bicycle"},
    {q:"Spell this word",a:"Broccoli"},
    {q:"Spell this word",a:"Umbrella"},
    {q:"Spell this word",a:"Jewelry"},
    {q:"Spell this word",a:"Biscuit"},
    {q:"Spell this word",a:"Ceiling"},
    {q:"Spell this word",a:"Handkerchief"},
    {q:"Spell this word",a:"Government"},
    {q:"Spell this word",a:"Pharaoh"},
    {q:"Spell this word",a:"Yacht"},
    {q:"Spell this word",a:"Pigeon"},
    {q:"Spell this word",a:"Tuesday"},
  ...
  400:[
    ...
    {q:"Spell this word",a:"Accommodate"},
    {q:"Spell this word",a:"Privilege"},
    {q:"Spell this word",a:"Conscience"},
    {q:"Spell this word",a:"Bureaucracy"},
    {q:"Spell this word",a:"Maintenance"},
    {q:"Spell this word",a:"Questionnaire"},
    {q:"Spell this word",a:"Mischievous"},
    {q:"Spell this word",a:"Camouflage"},
    {q:"Spell this word",a:"Liaison"},
    {q:"Spell this word",a:"Hemorrhage"},
    {q:"Spell this word",a:"Acquaintance"},
    {q:"Spell this word",a:"Pseudonym"},
    {q:"Spell this word",a:"Silhouette"},
    {q:"Spell this word",a:"Fluorescent"},
    {q:"Spell this word",a:"Rendezvous"},
    {q:"Spell this word",a:"Connoisseur"},
    {q:"Spell this word",a:"Miscellaneous"},
    {q:"Spell this word",a:"Entrepreneur"},
    {q:"Spell this word",a:"Consensus"},
    {q:"Spell this word",a:"Dilapidated"},
    {q:"Spell this word",a:"Plagiarism"},
    {q:"Spell this word",a:"Vengeance"},
    {q:"Spell this word",a:"Reconnaissance"},
    {q:"Spell this word",a:"Colonel"},
    {q:"Spell this word",a:"Souvenir"},
    {q:"Spell this word",a:"Threshold"},
    {q:"Spell this word",a:"Labyrinth"},
    {q:"Spell this word",a:"Fascinating"},
    {q:"Spell this word",a:"Eccentric"},
    {q:"Spell this word",a:"Guarantee"},
    {q:"Spell this word",a:"Exhilarate"},
    {q:"Spell this word",a:"Asphyxiate"},
    {q:"Spell this word",a:"Chauffeur"},
    {q:"Spell this word",a:"Archipelago"},
    {q:"Spell this word",a:"Bouquet"},
    {q:"Spell this word",a:"Parallel"},
    {q:"Spell this word",a:"Rhinoceros"},
    {q:"Spell this word",a:"Gauge"},
    {q:"Spell this word",a:"Vacillate"},
  ...
  600:[
    ...
    {q:"Spell this word",a:"Chiaroscuro"},
    {q:"Spell this word",a:"Sacrilegious"},
    {q:"Spell this word",a:"Epitome"},
    {q:"Spell this word",a:"Ubiquitous"},
    {q:"Spell this word",a:"Paraphernalia"},
    {q:"Spell this word",a:"Mnemonic"},
    {q:"Spell this word",a:"Idiosyncrasy"},
    {q:"Spell this word",a:"Apocryphal"},
    {q:"Spell this word",a:"Acquiesce"},
    {q:"Spell this word",a:"Sesquipedalian"},
    {q:"Spell this word",a:"Gargantuan"},
    {q:"Spell this word",a:"Chrysanthemum"},
    {q:"Spell this word",a:"Cacophony"},
    {q:"Spell this word",a:"Obsequious"},
    {q:"Spell this word",a:"Sycophant"},
    {q:"Spell this word",a:"Ephemeral"},
    {q:"Spell this word",a:"Quintessential"},
    {q:"Spell this word",a:"Soliloquy"},
    {q:"Spell this word",a:"Paradigm"},
    {q:"Spell this word",a:"Xenophobia"},
    {q:"Spell this word",a:"Bougainvillea"},
    {q:"Spell this word",a:"Pterodactyl"},
    {q:"Spell this word",a:"Hieroglyphic"},
    {q:"Spell this word",a:"Ignominious"},
    {q:"Spell this word",a:"Perspicacious"},
    {q:"Spell this word",a:"Subpoena"},
    {q:"Spell this word",a:"Phlegmatic"},
    {q:"Spell this word",a:"Zeitgeist"},
    {q:"Spell this word",a:"Gesundheit"},
    {q:"Spell this word",a:"Obstreperous"},
    {q:"Spell this word",a:"Pneumonia"},
    {q:"Spell this word",a:"Anemone"},
    {q:"Spell this word",a:"Eleemosynary"},
    {q:"Spell this word",a:"Antediluvian"},
    {q:"Spell this word",a:"Juxtaposition"},
    {q:"Spell this word",a:"Quixotic"},
...
const CAT_GROUPS = [
  ...
  { label:"\u{1F5BC}\uFE0F Who Am I?", ids:["who_footballer","who_tv_character","who_anime_character","who_movie_character","who_historic_figure","who_animal","who_country_landmark","who_influencer","who_artist","guess_young_celebrity"] },
...
const CATEGORY_PREVIEWS = {
  ...
  guess_young_celebrity:{src:"/whoami/young-marilyn-monroe-2a10c463.jpg",boardSrc:"/whoami/young-marilyn-monroe-2a10c463.jpg",fit:"cover",cardPosition:"center top",boardFit:"cover",boardPosition:"center",boardBg:"#1e1b4b",caption:"Guess the young star"},
  who_artist:{src:"/whoami/beyonce-40d5ed43.jpg",boardSrc:"/whoami/beyonce-40d5ed43.jpg",fit:"cover",cardPosition:"center top",boardFit:"cover",boardPosition:"center",boardBg:"#080A10",caption:"Guess the artist"},
  country_capitals:{src:"/category-previews/country_capitals.jpg",boardSrc:"/category-previews/country_capitals.jpg",fit:"cover",cardPosition:"center",boardFit:"cover",boardPosition:"center",caption:"Name the country"},
  spelling_bee:{src:"/category-previews/spelling_bee.jpg",boardSrc:"/category-previews/spelling_bee.jpg",fit:"contain",cardFit:"cover",cardPosition:"center",boardFit:"contain",boardPosition:"center",boardBg:"#F8FAFC",bg:"#FFFFFF",caption:"Spell it right"},
...
function SpellingBeeScreen({tile,teams,scores,curTeam,showAns,onRevealAnswer,onAward,onWrong,onPass,onAdjustScore,onBackToBoard,gameMode,lifelines,onUseLifeline,activeDoublePoints,timerPaused}){
  const isTouch=useIsTouchDevice();
  const pc=PT_COLORS[tile.pts];const pb=PT_BG[tile.pts];
  const word=tile.a||"";
  const audioRef=useRef(null);
